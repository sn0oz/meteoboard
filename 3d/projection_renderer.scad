...
module projection_renderer(render_index = -1, render_etch = false, render_mark = false, render_engrave = false, kerf_width = 0,
                                                        panel_height, panel_horizontal, panel_vertical) {
    ...
    if (render_index == -1) {
        ...
        translate([(panel_horizontal == 1 ? -kerf_width : 0), (panel_horizontal == 1 ? panel_height - kerf_width : 0) - panel_vertical * panel_height]) {
            rotate([0, 0, panel_horizontal == 1 ? 180 : 0]) {
                offset_size = (render_etch || render_mark || render_engrave ? -kerf_width : kerf_width)/2;
